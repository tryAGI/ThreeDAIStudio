...
namespace ThreeDAIStudio
{
    public partial class ToolsClient
    {
        ...
        private static readonly global::ThreeDAIStudio.EndPointSecurityRequirement s_CreateConvertTaskSecurityRequirement0 =
        ...
        private static readonly global::ThreeDAIStudio.EndPointSecurityRequirement[] s_CreateConvertTaskSecurityRequirements =
            new global::ThreeDAIStudio.EndPointSecurityRequirement[]
            {                s_CreateConvertTaskSecurityRequirement0,
            };
        partial void PrepareCreateConvertTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ThreeDAIStudio.ConvertRequest request);
        partial void PrepareCreateConvertTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ThreeDAIStudio.ConvertRequest request);
        partial void ProcessCreateConvertTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateConvertTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.GenerationTaskResponse> CreateConvertTaskAsync(

            global::ThreeDAIStudio.ConvertRequest request,
            global::ThreeDAIStudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateConvertTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ThreeDAIStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.AutoSDKHttpResponse<global::ThreeDAIStudio.GenerationTaskResponse>> CreateConvertTaskAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateConvertTaskArguments(
            ...
            var __authorizations = global::ThreeDAIStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateConvertTaskSecurityRequirements,
                operationName: "CreateConvertTaskAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateConvertTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateConvertTaskAsync",
                                pathTemplate: "\"/v1/tools/convert/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateConvertTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateConvertTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.GenerationTaskResponse> CreateConvertTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ThreeDAIStudio.ConvertRequest
            {
                ModelUrl = modelUrl,
                Model = model,
            ...
            return await CreateConvertTaskAsync(
                request: __request,
                requestOptions: requestOptions,
