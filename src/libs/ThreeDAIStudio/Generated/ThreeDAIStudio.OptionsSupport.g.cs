...
namespace ThreeDAIStudio
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::ThreeDAIStudio.AutoSDKRetryOptions Retry { get; set; } = new global::ThreeDAIStudio.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::ThreeDAIStudio.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::ThreeDAIStudio.IAutoSDKHook>();
        ...
        public global::ThreeDAIStudio.AutoSDKClientOptions AddHook(
            global::ThreeDAIStudio.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::ThreeDAIStudio.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::ThreeDAIStudio.AutoSDKClientOptions UseAuthorizationProvider(
            global::ThreeDAIStudio.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::ThreeDAIStudio.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::ThreeDAIStudio.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::ThreeDAIStudio.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::ThreeDAIStudio.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::ThreeDAIStudio.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::ThreeDAIStudio.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::ThreeDAIStudio.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::ThreeDAIStudio.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::ThreeDAIStudio.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::ThreeDAIStudio.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::ThreeDAIStudio.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::ThreeDAIStudio.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::ThreeDAIStudio.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::ThreeDAIStudio.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::ThreeDAIStudio.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::ThreeDAIStudio.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::ThreeDAIStudio.AutoSDKClientOptions clientOptions,
            global::ThreeDAIStudio.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::ThreeDAIStudio.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::ThreeDAIStudio.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::ThreeDAIStudio.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::ThreeDAIStudio.AutoSDKClientOptions clientOptions,
            global::System.Func<global::ThreeDAIStudio.IAutoSDKHook, global::ThreeDAIStudio.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::ThreeDAIStudio.AutoSDKHookContext context)
        {
