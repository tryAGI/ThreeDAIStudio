...
namespace ThreeDAIStudio
{
    public partial class TripoClient
    {
        ...
        private static readonly global::ThreeDAIStudio.EndPointSecurityRequirement s_CreateTripoMultiviewTo3DVersionTaskSecurityRequirement0 =
        ...
        private static readonly global::ThreeDAIStudio.EndPointSecurityRequirement[] s_CreateTripoMultiviewTo3DVersionTaskSecurityRequirements =
            new global::ThreeDAIStudio.EndPointSecurityRequirement[]
            {                s_CreateTripoMultiviewTo3DVersionTaskSecurityRequirement0,
            };
        partial void PrepareCreateTripoMultiviewTo3DVersionTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::ThreeDAIStudio.CreateTripoMultiviewTo3DVersionTaskVersion version,
            global::ThreeDAIStudio.TripoMultiviewTo3DRequest request);
        partial void PrepareCreateTripoMultiviewTo3DVersionTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ThreeDAIStudio.CreateTripoMultiviewTo3DVersionTaskVersion version,
            global::ThreeDAIStudio.TripoMultiviewTo3DRequest request);
        partial void ProcessCreateTripoMultiviewTo3DVersionTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTripoMultiviewTo3DVersionTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.GenerationTaskResponse> CreateTripoMultiviewTo3DVersionTaskAsync(
            global::ThreeDAIStudio.CreateTripoMultiviewTo3DVersionTaskVersion version,
        ...
        {
            var __response = await CreateTripoMultiviewTo3DVersionTaskAsResponseAsync(
                version: version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ThreeDAIStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.AutoSDKHttpResponse<global::ThreeDAIStudio.GenerationTaskResponse>> CreateTripoMultiviewTo3DVersionTaskAsResponseAsync(
            global::ThreeDAIStudio.CreateTripoMultiviewTo3DVersionTaskVersion version,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTripoMultiviewTo3DVersionTaskArguments(
            ...
            var __authorizations = global::ThreeDAIStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTripoMultiviewTo3DVersionTaskSecurityRequirements,
                operationName: "CreateTripoMultiviewTo3DVersionTaskAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ThreeDAIStudio.PathBuilder(
                                path: $"/v1/3d-models/tripo/multiview-to-3d/{(global::System.Uri.EscapeDataString(version.ToValueString()))}/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTripoMultiviewTo3DVersionTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTripoMultiviewTo3DVersionTask",
                                methodName: "CreateTripoMultiviewTo3DVersionTaskAsync",
                                pathTemplate: "$\"/v1/3d-models/tripo/multiview-to-3d/{(global::System.Uri.EscapeDataString(version.ToValueString()))}/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTripoMultiviewTo3DVersionTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTripoMultiviewTo3DVersionTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.GenerationTaskResponse> CreateTripoMultiviewTo3DVersionTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ThreeDAIStudio.TripoMultiviewTo3DRequest
            {
            };

            return await CreateTripoMultiviewTo3DVersionTaskAsync(
                version: version,
                request: __request,
                requestOptions: requestOptions,
