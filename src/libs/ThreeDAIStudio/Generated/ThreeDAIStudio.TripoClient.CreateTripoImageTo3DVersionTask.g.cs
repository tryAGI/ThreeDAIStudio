...
namespace ThreeDAIStudio
{
    public partial class TripoClient
    {
        ...
        private static readonly global::ThreeDAIStudio.EndPointSecurityRequirement s_CreateTripoImageTo3DVersionTaskSecurityRequirement0 =
        ...
        private static readonly global::ThreeDAIStudio.EndPointSecurityRequirement[] s_CreateTripoImageTo3DVersionTaskSecurityRequirements =
            new global::ThreeDAIStudio.EndPointSecurityRequirement[]
            {                s_CreateTripoImageTo3DVersionTaskSecurityRequirement0,
            };
        partial void PrepareCreateTripoImageTo3DVersionTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::ThreeDAIStudio.CreateTripoImageTo3DVersionTaskVersion version,
            global::ThreeDAIStudio.TripoImageTo3DRequest request);
        partial void PrepareCreateTripoImageTo3DVersionTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ThreeDAIStudio.CreateTripoImageTo3DVersionTaskVersion version,
            global::ThreeDAIStudio.TripoImageTo3DRequest request);
        partial void ProcessCreateTripoImageTo3DVersionTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTripoImageTo3DVersionTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate a Tripo model from one image with a specific model version
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.GenerationTaskResponse> CreateTripoImageTo3DVersionTaskAsync(
            global::ThreeDAIStudio.CreateTripoImageTo3DVersionTaskVersion version,
        ...
        {
            var __response = await CreateTripoImageTo3DVersionTaskAsResponseAsync(
                version: version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ThreeDAIStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.AutoSDKHttpResponse<global::ThreeDAIStudio.GenerationTaskResponse>> CreateTripoImageTo3DVersionTaskAsResponseAsync(
            global::ThreeDAIStudio.CreateTripoImageTo3DVersionTaskVersion version,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTripoImageTo3DVersionTaskArguments(
            ...
            var __authorizations = global::ThreeDAIStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTripoImageTo3DVersionTaskSecurityRequirements,
                operationName: "CreateTripoImageTo3DVersionTaskAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ThreeDAIStudio.PathBuilder(
                                path: $"/v1/3d-models/tripo/image-to-3d/{(global::System.Uri.EscapeDataString(version.ToValueString()))}/",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTripoImageTo3DVersionTask",
                                methodName: "CreateTripoImageTo3DVersionTaskAsync",
                                pathTemplate: "$\"/v1/3d-models/tripo/image-to-3d/{(global::System.Uri.EscapeDataString(version.ToValueString()))}/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTripoImageTo3DVersionTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ThreeDAIStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTripoImageTo3DVersionTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                {
                                    throw global::ThreeDAIStudio.ApiException.Create(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::ThreeDAIStudio.GenerationTaskResponse> CreateTripoImageTo3DVersionTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ThreeDAIStudio.TripoImageTo3DRequest
            {
            };

            return await CreateTripoImageTo3DVersionTaskAsync(
                version: version,
                request: __request,
                requestOptions: requestOptions,
