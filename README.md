<div class="docs-hero">
  <h1>ThreeDAIStudio</h1>
  <p class="docs-hero-lead">Modern .NET SDK for ThreeDAIStudio generated from the provider's OpenAPI definition with AutoSDK.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/ThreeDAIStudio/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/ThreeDAIStudio"></a>
    <a href="https://github.com/tryAGI/ThreeDAIStudio/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/ThreeDAIStudio/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/ThreeDAIStudio/blob/main/LICENSE.txt"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/ThreeDAIStudio"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from a locally maintained OpenAPI definition based on <a href="https://www.3daistudio.com/Platform/API/Documentation/overview">3D AI Studio's public API documentation</a> so the SDK stays close to the upstream API surface.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
```csharp
using ThreeDAIStudio;

using var client = new ThreeDAIStudioClient(apiKey);
```
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/ThreeDAIStudio/issues">tryAGI/ThreeDAIStudio</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/ThreeDAIStudio/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
