...
The ThreeDAIStudio SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package ThreeDAIStudio
```
...
using var client = new ThreeDAIStudioClient(
    apiKey: Environment.GetEnvironmentVariable("THREEDAISTUDIO_API_KEY")!);
